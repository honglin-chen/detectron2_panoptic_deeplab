...
_RAW_PLAYROOM_LARGE_V1_SPLITS = {
    ...
    "playroom_large_v3_images/test": (['val'], "*"),
    "playroom_large_v3_images/vis_val": ([4], "00*1"),
    "playroom_large_v3_images/safari": (['playroom_simple_v7safari'], "*"),
    "playroom_large_v3_images/occlude": (['playroom_occlude1'], "*"),
    "playroom_large_v3_images/cylinder": (['cylinder_miss_contain_boxroom'], "*"),
