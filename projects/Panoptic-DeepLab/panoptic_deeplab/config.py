...
def add_panoptic_deeplab_config(cfg):
    ...
    cfg.MODEL.PANOPTIC_DEEPLAB.PREDICT_THING_MASK = False
    cfg.MODEL.PANOPTIC_DEEPLAB.FULL_SUPERVISION = False
    cfg.MODEL.PANOPTIC_DEEPLAB.STUDENT_TEACHER = False
    cfg.MODEL.PANOPTIC_DEEPLAB.ROUND_2 = False
